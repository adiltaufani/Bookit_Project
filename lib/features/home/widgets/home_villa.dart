...
class HomeVilla extends StatefulWidget {
  const HomeVilla({super.key});

  @override
  State<HomeVilla> createState() => _HomeVillaState();
}

class _HomeVillaState extends State<HomeVilla> {
  List _Listdata = [];

  Future _getdata() async {
    try {
      final response = await http.get(
        Uri.parse('http://192.168.100.10/ta_projek/crudtaprojek/readvilla.php'),
      );
