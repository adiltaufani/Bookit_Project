...
class HomeApartement extends StatefulWidget {
  const HomeApartement({super.key});

  @override
  State<HomeApartement> createState() => _HomeApartementState();
}

class _HomeApartementState extends State<HomeApartement> {
  List _Listdata = [];
  ...
  Future _getdata() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.1.6/ta_projek/crudtaprojek/readapartement.php'),
      );
